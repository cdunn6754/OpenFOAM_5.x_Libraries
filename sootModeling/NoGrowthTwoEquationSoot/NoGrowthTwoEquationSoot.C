...
// Constructor
Foam::NoGrowthTwoEquationSoot::NoGrowthTwoEquationSoot
(
...
// Member functions
void Foam::NoGrowthTwoEquationSoot::ratesOfChange
(
    scalar& r_growth,
...
void Foam::NoGrowthTwoEquationSoot::explicitStep
(
...
void Foam::NoGrowthTwoEquationSoot::advanceToZero
(
...
void Foam::NoGrowthTwoEquationSoot::exhaustLowSpecie
(
    const scalar totalTime, 
    scalar& smallSubTime,
    const scalarField& Y_initial,
...
void Foam::NoGrowthTwoEquationSoot::correctQdot()
{
...
void Foam::NoGrowthTwoEquationSoot::calcSpecieSources
(
    const scalar dt,
...
Foam::tmp<Foam::volScalarField> Foam::NoGrowthTwoEquationSoot::Qdot()
{
...
Foam::tmp<Foam::volScalarField> Foam::NoGrowthTwoEquationSoot::sourceN()
{
...
Foam::tmp<Foam::volScalarField> Foam::NoGrowthTwoEquationSoot::sourceY
(
...
// all cells
void Foam::NoGrowthTwoEquationSoot::updateSources
(
    const label nSubSteps
)
{  
