...
// Constructor
Foam::PCFSootTarModel::PCFSootTarModel
(
...
)
{
    ...
    // Rate constants from PCCLConversion Framework
    // Added on 07-11-18
    const scalar A_soot(4.9716e8);  //[1/s]
    const scalar E_soot(191.82);   //[kJ/mol]

    const scalar A_gas(2.789e1); //[1/s]
    const scalar E_gas(0.796);   //[kJ/mol]
...
void Foam::PCFSootTarModel::explicitStep
(
...
void Foam::PCFSootTarModel::correctQdot()
{
...
Switch Foam::PCFSootTarModel::negativeFinalMassFraction()
{
...
void Foam::PCFSootTarModel::exhaustWorstSpecies
(
    const scalar& subdt,
...
word Foam::PCFSootTarModel::findWorstSpecies()
{
...
void Foam::PCFSootTarModel::updateSpeciesMassFractions()
{
...
void Foam::PCFSootTarModel::setSpeciesSources
(
    const scalar& dt
)
{
...
void Foam::PCFSootTarModel::calcSpecieSources
(
    const scalar dt,
...
Foam::tmp<Foam::volScalarField> Foam::PCFSootTarModel::Qdot()
{
...
Foam::tmp<Foam::volScalarField> Foam::PCFSootTarModel::sourceY
(
...
// all cells
void Foam::PCFSootTarModel::updateSources
(
    const label nSubSteps
)
{  
