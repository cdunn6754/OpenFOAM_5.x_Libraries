...
const Foam::label Foam::PcReactingMultiphaseParcel<ParcelType>::GAS(0);

template<class ParcelType>
const Foam::label Foam::PcReactingMultiphaseParcel<ParcelType>::LIQ(1);

template<class ParcelType>
const Foam::label Foam::PcReactingMultiphaseParcel<ParcelType>::SLD(2);
...
Foam::scalar Foam::PcReactingMultiphaseParcel<ParcelType>::CpEff
(
    TrackData& td,
    const scalar p,
    const scalar T,
...
template<class ParcelType>
template<class TrackData>
Foam::scalar Foam::PcReactingMultiphaseParcel<ParcelType>::HsEff
(
    TrackData& td,
    const scalar p,
    const scalar T,
...
template<class ParcelType>
template<class TrackData>
Foam::scalar Foam::PcReactingMultiphaseParcel<ParcelType>::LEff
(
    TrackData& td,
    const scalar p,
    const scalar T,
...
template<class ParcelType>
Foam::scalar Foam::PcReactingMultiphaseParcel<ParcelType>::updateMassFractions
(
    const scalar mass0,
...
template<class ParcelType>
template<class TrackData>
void Foam::PcReactingMultiphaseParcel<ParcelType>::setCellValues
(
    TrackData& td,
    const scalar dt,
    const label celli
...
template<class ParcelType>
template<class TrackData>
void Foam::PcReactingMultiphaseParcel<ParcelType>::cellValueSourceCorrection
(
    TrackData& td,
    const scalar dt,
    const label celli
...
template<class ParcelType>
template<class TrackData>
void Foam::PcReactingMultiphaseParcel<ParcelType>::calc
(
    TrackData& td,
    const scalar dt,
    const label celli
...
template<class ParcelType>
template<class TrackData>
void Foam::PcReactingMultiphaseParcel<ParcelType>::calcDevolatilisation
(
    TrackData& td,
    const scalar dt,
    const scalar age,
...
template<class ParcelType>
template<class TrackData>
void Foam::PcReactingMultiphaseParcel<ParcelType>::calcSurfaceReactions
(
    TrackData& td,
    const scalar dt,
    const label celli,
...
template<class ParcelType>
Foam::PcReactingMultiphaseParcel<ParcelType>::PcReactingMultiphaseParcel
(
    const PcReactingMultiphaseParcel<ParcelType>& p
)
:
    ParcelType(p),
    YGas_(p.YGas_),
...
#include "PcReactingMultiphaseParcelIO.C"
