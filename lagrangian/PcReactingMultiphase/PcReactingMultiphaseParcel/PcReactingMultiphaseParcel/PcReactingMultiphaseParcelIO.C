...
Foam::string Foam::PcReactingMultiphaseParcel<ParcelType>::propertyList_ =
    Foam::PcReactingMultiphaseParcel<ParcelType>::propertyList();

template<class ParcelType>
const std::size_t Foam::PcReactingMultiphaseParcel<ParcelType>::sizeofFields_
(
    0
);
    ...
    canCombust_(0)
{
  //Info << "\nConstructed from ISTREAM \n" << endl;
    ...
    is.check
    (
        "PcReactingMultiphaseParcel<ParcelType>::PcReactingMultiphaseParcel"
        "("
            "const polyMesh&, "
            "Istream&, "
            "bool"
...
void Foam::PcReactingMultiphaseParcel<ParcelType>::readFields(CloudType& c)
{
    if (!c.size())
    {
        return;
...
void Foam::PcReactingMultiphaseParcel<ParcelType>::readFields
(
    CloudType& c,
...
)
{
  Info << "\nIn read fields" << endl;
    ...
    forAllIter(typename Cloud<PcReactingMultiphaseParcel<ParcelType>>, c, iter)
    {
    ...
    forAll(gasNames, j)
    {
        ...
        forAllIter
        (
            typename Cloud<PcReactingMultiphaseParcel<ParcelType>>,
            c,
            iter
        )
        {
...
template<class ParcelType>
template<class CloudType>
void Foam::PcReactingMultiphaseParcel<ParcelType>::writeFields(const CloudType& c)
{
...
template<class ParcelType>
template<class CloudType, class CompositionType>
void Foam::PcReactingMultiphaseParcel<ParcelType>::writeFields
(
    const CloudType& c,
    const CompositionType& compModel
)
{
    ...
    if (np > 0)
    {
        ...
        forAll(gasNames, j)
        {
            ...
            {
                const PcReactingMultiphaseParcel<ParcelType>& p0 = iter();
...
)
{
    ...
    (
        ...
        "("
            "Ostream&, "
            "const PcReactingMultiphaseParcel<ParcelType>&"
        ")"
    );
