...
Foam::autoPtr<Foam::combustionModels::sootPsiCombustionModel>
Foam::combustionModels::sootPsiCombustionModel::New
(
    const fvMesh& mesh,
...
)
{
    ...
    if (cstrIter == dictionaryConstructorTablePtr_->end())
    {
        FatalErrorInFunction
            << "Unknown sootPsiCombustionModel type "
    ...
    return autoPtr<sootPsiCombustionModel>
    (
